...
namespace Z80CPU.Instructions
{
    ...
    [Flag(Name.Overflow, Affect.DefaultCalculation)]
    ...
    public class ADD : Instruction
    {
        protected override void AddOpcodes()
        {
            ...
            var opcodeFlagOveride = new OpcodeFlagOverride()
            {
                FlagSign = Affect.None,
                FlagZero = Affect.None,
                FlagHalfCarry = Affect.Undefined,
                FlagOverflow = Affect.None
            };

            Opcodes.AddRange(opcodeFlagOveride.Create(null,
