    ...
    public class BIT : Instruction
    {
        protected override void AddOpcodes()
        {
            Opcodes.AddRange(new List<Opcode>
            {
                ...
                new Opcode("BIT 0, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x46, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(0).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 1, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x4E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(1).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 2, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x56, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(2).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 3, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x5E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(3).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 4, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x66, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(4).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 5, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x6E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(5).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 6, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x76, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(6).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 7, (IX + d)", 0xDD, 0xCB, Oprand.Any, 0x7E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IX.Value + z80.Buffer[2]).GetBit(7).IsZero(); return TStates.Count(20); }),

                new Opcode("BIT 0, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x46, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(0).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 1, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x4E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(1).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 2, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x56, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(2).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 3, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x5E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(3).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 4, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x66, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(4).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 5, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x6E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(5).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 6, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x76, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(6).IsZero(); return TStates.Count(20); }),
                new Opcode("BIT 7, (IY + d)", 0xFD, 0xCB, Oprand.Any, 0x7E, (z80) => { z80.F.Zero = z80.Memory.Get(z80.IY.Value + z80.Buffer[2]).GetBit(7).IsZero(); return TStates.Count(20); }),
